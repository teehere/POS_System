...
3. **Membership and payment process**
    ...
    - The discount rates given based on the type of membership in which the customer is subscribed to. The membership types: Premium, Gold, and Normal with a discount rate of 20%, 10% and 5% respectively
